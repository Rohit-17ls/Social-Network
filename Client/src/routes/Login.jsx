...
const Login = () => {
    ...
    const {setUsername, getCredentials, setPassword, postCredentials, setAuthState} = useContext(AuthContext);
    ...
    const authenticate = async() => {
        ...
        try{
            ...
            if(result.loggedIn){
               setAuthState(true);
                navigate(`/user/${getCredentials().username}`);
            }else{
                 console.log(result);
   ...
   return(
    <div className = 'm-auto p-10 max-w-2/3 min-w-fit bg-bglight rounded-xl'>
            ...
            <table className="m-auto border-separate border-spacing-4">
              ...
              <tbody>
               <tr style={{'marginTop' : '10px'}}>
                  ...
                  <tr>
                     <td colSpan={3}>
                        <span>Don't have an account? <b className="text-themecolor underline hover:cursor-pointer" onClick={() => {navigate('/signup')}}>Signup</b></span>
                     </td>
                  </tr>
