...
const Signup = () => {
   ...
   return(
    <div className = 'm-auto p-10 max-w-1/2 min-w-fit bg-bglight rounded-xl'>
            ...
            <table className="m-auto border-separate border-spacing-4">
              ...
              <tbody>
               <tr style={{'marginTop' : '10px'}}>
                  ...
                  <tr>
                     <td colSpan={3}>
                        <span>Already have an account? <b className="text-themecolor underline hover:cursor-pointer" onClick={() => {navigate('/login')}}>Login</b></span>
                     </td>
                  </tr>
